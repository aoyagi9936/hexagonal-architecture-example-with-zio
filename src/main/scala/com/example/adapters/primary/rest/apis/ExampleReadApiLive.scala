...
object ExampleReadApiLive {

  val layer: ZLayer[AuthorizationFilter.Service with BizDomainA.Service, PrimaryError, ExampleReadApi] = ZLayer {
    for {
