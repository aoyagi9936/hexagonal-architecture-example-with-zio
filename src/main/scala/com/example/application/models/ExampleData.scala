...
import com.example.application.models.ExampleData.Origin.{ BELT, EARTH, MARS }
import com.example.application.models.ExampleData.Role.{ Captain, Engineer, Mechanic, Pilot }
